...
class ResourceProvider {
  ...
  Stream<int> init() {
    ...
    controller = StreamController(onListen: () async {
      if (desc == null) {
        wall = await readFile("packages/showcase_library/assets/hglfng_flutter_bananamon/resource/sprite_bricks.png");
        //TODO 返回具体文件大小
        //TODO 并行加载
        controller.add(1);
        wallsolid = await readFile("packages/showcase_library/assets/hglfng_flutter_bananamon/resource/sprite_bricks_solid.png");
        controller.add(2);
        huaji = await readFile("packages/showcase_library/assets/hglfng_flutter_bananamon/resource/huaji90x90.png");
        controller.add(3);
        hero1 = await readFile("packages/showcase_library/assets/hglfng_flutter_bananamon/resource/hero1.png");
        controller.add(4);
        bomb1 = await readFile("packages/showcase_library/assets/hglfng_flutter_bananamon/resource/bomb1.png");
        controller.add(5);
        explosion = await readFile("packages/showcase_library/assets/hglfng_flutter_bananamon/resource/explosion.png");
        controller.add(6);
        blocck_destory = await readFile("packages/showcase_library/assets/hglfng_flutter_bananamon/resource/block_destory.png");
        controller.add(7);
        monster_destory = await readFile("packages/showcase_library/assets/hglfng_flutter_bananamon/resource/monster_destory.png");
        controller.add(8);
        treasures = await readFile("packages/showcase_library/assets/hglfng_flutter_bananamon/resource/treasure.png");
        controller.add(9);
        gate = await readFile("packages/showcase_library/assets/hglfng_flutter_bananamon/resource/gate.png");
        controller.add(10);
        desc = jsonDecode(await readString("packages/showcase_library/assets/hglfng_flutter_bananamon/resource/desc.json"));
        controller.add(11);
      }
