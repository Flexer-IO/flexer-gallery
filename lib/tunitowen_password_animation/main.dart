...
/// A compatibility wrapper for the removed [FlatButton] widget.
/// It mimics the original API using a [TextButton] under the hood.
  ...
  void initState() {
    ...
    textController.addListener(() {
      setState(() {
        ...
        upperCaseChar =
            textController.text.contains(RegExp(r'[A-Z]'), 0);
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: <Widget>[
            Padding(padding: const EdgeInsets.all(32.0), child: _validationStack()),
            Padding(
  ...
  Stack _validationStack() {
    return Stack(
      ...
      children: <Widget>[
        ...
        // The inner content of the above Card is built separately to keep
