...
// Updated imports to use relative paths for null‑safety and Dart 3 compatibility
...
class AnimatedMeshGradient extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return TweenAnimationBuilder<Mesh25Data>(
...
final PlaneGeometry _meshGeometry = PlaneGeometry(xSegments: 4, ySegments: 4);
