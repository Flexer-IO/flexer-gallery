...
class $AssetsImagesGen {
  ...
  AssetGenImage get bgrockbase =>
      const AssetGenImage('packages/showcase_library/assets/renancaraujo_turi/images/bgrockbase.png');

  /// File path: assets/images/bgrockpillar.png
  AssetGenImage get bgrockpillar =>
      const AssetGenImage('packages/showcase_library/assets/renancaraujo_turi/images/bgrockpillar.png');

  /// File path: assets/images/bottomRocks1.png
  AssetGenImage get bottomRocks1 =>
      const AssetGenImage('packages/showcase_library/assets/renancaraujo_turi/images/bottomRocks1.png');

  /// File path: assets/images/rocksl.png
  AssetGenImage get rocksl => const AssetGenImage('packages/showcase_library/assets/renancaraujo_turi/images/rocksl.png');

  /// File path: assets/images/rocksl2.png
  AssetGenImage get rocksl2 => const AssetGenImage('packages/showcase_library/assets/renancaraujo_turi/images/rocksl2.png');

  /// File path: assets/images/rocksr.png
  AssetGenImage get rocksr => const AssetGenImage('packages/showcase_library/assets/renancaraujo_turi/images/rocksr.png');

  /// File path: assets/images/turilogo.png
  AssetGenImage get turilogo =>
      const AssetGenImage('packages/showcase_library/assets/renancaraujo_turi/images/turilogo.png');
...
class $AssetsLicensesMacondoGen {
  ...
  String get ofl => 'packages/showcase_library/assets/renancaraujo_turi/licenses/macondo/OFL.txt';
