                ...
                snapshot.hasData
                    ? Stack(
                        children: <Widget>[
                          ...
                          Transform.rotate(
                            angle: ((snapshot.data!.minute +
                                        (((snapshot.data!.second * 100) / 60) /
                                            100)) *
                                    6.0 *
                                    radian),
                            child: CustomPaint(
                          ...
                          Transform.rotate(
                            angle: ((snapshot.data!.hour % 12) * 30.0 +
                                    ((snapshot.data!.minute * 30) / 60)) *
                                radian,
                            child: CustomPaint(
...
class ClockPainter extends CustomPainter {
  ...
  void _drawText(Offset offset, Canvas canvas, int i) {
    ...
    txtPainter.paint(
        canvas,
        Offset(offset.dx - (txtPainter.width / 2),
            offset.dy - (txtPainter.height / 2)));
  }
}