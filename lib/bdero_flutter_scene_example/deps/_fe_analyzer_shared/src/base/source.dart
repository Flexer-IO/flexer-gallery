...
import './analyzer_public_api.dart';
...
@AnalyzerPublicApi(message: 'Exported by package:analyzer/source/source.dart')
abstract class Source {
  ...
  /// with local content is considered to exist even if there is no file on
  /// disk.
  bool exists();
}
