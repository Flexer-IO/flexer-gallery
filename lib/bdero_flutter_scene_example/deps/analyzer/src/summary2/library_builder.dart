...
import '../dart/analysis/file_state.dart' as file_state;
import '../dart/analysis/file_state.dart' hide DirectiveUri;
import '../dart/analysis/unlinked_data.dart';
import '../dart/ast/ast.dart' as ast;
import '../dart/ast/mixin_super_invoked_names.dart';
import '../dart/element/element.dart';
import '../dart/element/field_name_non_promotability_info.dart'
    as element_model;
import '../dart/resolver/scope.dart';
import './combinator.dart';
import './constructor_initializer_resolver.dart';
import './default_value_resolver.dart';
import './element_builder.dart';
import './export.dart';
import './informative_data.dart';
import './link.dart';
