...
import 'deps/digital_clock/digital_clock.dart';
import 'deps/colours/colours.dart';
import 'package:flutter/services.dart';
import 'config/application.dart';
import 'config/constants.dart';
import 'config/setting.dart';
import 'widget/clockSetting.dart';
import 'package:flutter/material.dart';
import 'deps/wakelock/wakelock.dart';
...
class ClockComponentState extends State<ClockComponent>
  ...
  DigitalClockConfig textClock = DigitalClockConfig(
    ...
    // backgroundImage: "packages/showcase_library/assets/olgeer_justclock/clock/bg.png",
    // bodyImage: "packages/showcase_library/assets/olgeer_justclock/clock/body.png",
  ...
  void initState() {
    ...
    Application.myClock = AlarmClock(
        ...
        quarterAlarmSound: "packages/showcase_library/assets/olgeer_justclock/sounds/钟琴颤音.mp3",
        halfAlarmSound: "packages/showcase_library/assets/olgeer_justclock/sounds/短促欢愉.mp3",
        hourAlarmSound: "packages/showcase_library/assets/olgeer_justclock/sounds/座钟报时.mp3",
