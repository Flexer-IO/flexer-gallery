          ...
          child: Container(
            ...
            child: Stack(
              ...
              children: [
                ...
                if (!open && dotColor != null)
                  Positioned(
                    top: 7,
                    right: 7,
                    child: _ColorDot(color: dotColor!),
                  ),
              ],
            ),
          ),
...
class _DrawerPanelState extends State<_DrawerPanel> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      final itemCenter =
          _listPadding + widget.currentIndex * _itemExtent + _itemExtent / 2;
...
class _Header extends StatelessWidget {
  const _Header({required this.total, required this.selectedCount});
  final int total;
...
class _PaletteTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final accent =
        palette.colors[ClockColor.analogTimeBackground] ??
        palette.colors[ClockColor.ballPrimary] ??
        Colors.white;
    return Material(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: isCurrent ? Colors.white.withValues(alpha: 0.10) : null,
            border: Border(
              left: BorderSide(
                  ...
                  children: [
                    ...
                    ClipRRect(
                      ...
                      child: Row(
                        ...
                        children: [
                          for (final key in [
                            ClockColor.background,
                            ClockColor.analogTimeBackground,
                            ClockColor.ballPrimary,
                            ClockColor.goo,
                          ])
