      ...
      child: Scaffold(
        ...
        body: TabBarView(
          ...
          children: <Widget>[
            ...
            Container(
              height: 200.0,
              child: const Center(child: Text('TOP GROSSING')),
            ),
            Container(
              height: 200.0,
            ...
            Container(
              height: 200.0,
              child: const Center(child: Text('TOP PAID')),
            ),
            Container(
              height: 200.0,
              child: const Center(child: Text('TOP RATED')),
            ),
          ],
        ),
      ),
      ...
      child: ListView(
        ...
        children: <Widget>[
          ...
          ListTile(
            ...
            title: const Text('Jewels Classic'),
          ...
          ListTile(
            ...
            title: const Text('Street Racing 3D'),
          ...
          ListTile(
            ...
            title: const Text('Dream League Soccer 2019'),
