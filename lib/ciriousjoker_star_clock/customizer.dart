 ...
 class _ClockCustomizerState extends State<ClockCustomizer> {
     ...
     return InputDecorator(
       ...
       child: DropdownButtonHideUnderline(
         child: DropdownButton<T>(
           value: value,
           isDense: true,
           // Wrap the nullable callback expected by DropdownButton with a non‑nullable
           // callback that we receive.
           ...
           items: items.map((T item) {
             return DropdownMenuItem<T>(
               value: item,
               // Cast to Object to satisfy enumToString's expected type.
   ...
   Widget build(BuildContext context) {
     ...
     return MaterialApp(
       ...
       home: Scaffold(
         // Updated for null‑safety and newer Flutter versions.
