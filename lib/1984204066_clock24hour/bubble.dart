...
///气泡属性配置
class BobbleBean {
  late Offset postion; //位置
  late Color color; //颜色
  late double speed; //运动的速度
  late double theta; //角度
  late double radius; //半径
}
...
class BubblePainter extends CustomPainter {
  final Paint _paint = Paint(); //创建画笔
  final List<BobbleBean> list; //保存气泡的集合
  final Random random; //随机数变量

  BubblePainter({required this.list, required this.random});
