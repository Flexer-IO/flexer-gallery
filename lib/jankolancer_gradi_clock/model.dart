// Copyright 2019 The Chromium Authors. All rights reserved.
 ...
 class ClockModel extends ChangeNotifier {
   ...
   set temperature(num temperature) {
     final num converted = _convertToCelsius(temperature);
     if (converted != _temperature) {
       _temperature = converted;
   ...
   num _high = 26.0;
   set high(num high) {
     final num converted = _convertToCelsius(high);
     if (converted != _high) {
       _high = converted;
       notifyListeners();
     }
   ...
   num _low = 19.0;
   set low(num low) {
     final num converted = _convertToCelsius(low);
     if (converted != _low) {
       _low = converted;
       notifyListeners();
     }
