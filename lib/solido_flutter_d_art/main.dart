...
void main() {
  ...
  // Compute logical size from physical size and device pixel ratio.
  final logicalSize = Size(
    window.physicalSize.width / window.devicePixelRatio,
    window.physicalSize.height / window.devicePixelRatio,
  );

  // Use positional arguments for ViewConfiguration to avoid named argument issues.
  ...
  // Attach the render view to the binding and schedule a frame.
  (RendererBinding.instance as dynamic).renderView = renderView;
