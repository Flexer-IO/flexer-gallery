...
import 'notifiers/is_learning_mode_on_state_provider.dart';
import 'notifiers/nodes_state_notifier.dart';
import 'notifiers/selected_shortest_path_algorithm_state_notifier.dart';
import 'ui/common/playable_lottie/playable_lottie.dart';
import 'ui/common/playable_lottie/playable_lottie_asset.dart';
import 'ui/common/text/unit_rounded_text.dart';
import 'ui/widgets/panel/reset_buttons.dart';
import 'ui/widgets/panel/sliders.dart';
        ...
        children: [
          ...
          IconButton(
            ...
            icon: SvgPicture.asset(
              'packages/showcase_library/assets/igniti0n_flutter_algorithms_visualization/svg/github_logo.svg',
              height: 48,
              width: 48,
            ),
          ),
      ...
      children: [
        ...
        GestureDetector(
          ...
          child: SvgPicture.asset(
            'packages/showcase_library/assets/igniti0n_flutter_algorithms_visualization/svg/play_button.svg',
            color: selectedColor,
