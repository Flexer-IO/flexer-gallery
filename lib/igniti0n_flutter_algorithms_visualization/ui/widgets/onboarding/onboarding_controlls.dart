            ...
            child: Column(
              ...
              children: const [
                _TextWithImage(
                  ...
                  imagePath: 'packages/showcase_library/assets/igniti0n_flutter_algorithms_visualization/images/algorithm_choosing.png',
                ),
                _TextWithImage(
                  text: 'Control costs of horizontal & diagonal movement, turn on/off diagonal movement.',
                  imagePath: 'packages/showcase_library/assets/igniti0n_flutter_algorithms_visualization/images/cost_controls.png',
                ),
                _TextWithImage(
                  text: 'Slow down time to see the algorithm work better 🪄',
                  imagePath: 'packages/showcase_library/assets/igniti0n_flutter_algorithms_visualization/images/time_control.png',
                ),
                _TextWithImage(
                  text: 'Delete all with the trash can, or reset the algorithm to start.',
                  imagePath: 'packages/showcase_library/assets/igniti0n_flutter_algorithms_visualization/images/delete_reset.png',
                ),
              ],
            ),
          ),
