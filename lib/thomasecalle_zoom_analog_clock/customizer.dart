     ...
     return InputDecorator(
       ...
       child: DropdownButtonHideUnderline(
         child: DropdownButton<T>(
           value: value,
           isDense: true,
           // The DropdownButton expects a nullable callback; we forward only
           // non‑null selections to the provided non‑nullable handler.
           ...
           items: items.map((T item) {
             return DropdownMenuItem<T>(
               value: item,
               // Cast to Object to satisfy non‑nullable parameter of enumToString.
