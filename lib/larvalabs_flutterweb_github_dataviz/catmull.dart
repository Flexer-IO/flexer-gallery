...
/// Simple 2‑D point class used by the Catmull interpolator.
class Point2D {
  final double x;
  final double y;
...
/// Minimal interpolator interface required by [CatmullInterpolator].
...
class CatmullInterpolator implements Interpolator {
  ...
  static void test() {
    ...
    controlPoints.add(const Point2D(-1, 1));
    controlPoints.add(const Point2D(0, 1));
    controlPoints.add(const Point2D(1, -1));
    controlPoints.add(const Point2D(3, 4));
    controlPoints.add(const Point2D(10, -2));
    controlPoints.add(const Point2D(11, -2));
