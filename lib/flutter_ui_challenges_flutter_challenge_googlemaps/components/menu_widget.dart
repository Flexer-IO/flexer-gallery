...
class MenuWidget extends StatelessWidget {
  ...
  final void Function(bool) animateMenu;

  const MenuWidget({
    Key? key,
    required this.currentMenuPercent,
                  ...
                  children: <Widget>[
                    NotificationListener<OverscrollIndicatorNotification>(
                      onNotification: (notification) {
                        (notification as dynamic).disallowGlow();
                        return true;
                      },
                            ...
                            sliver: SliverFixedExtentList(
                              ...
                              delegate: SliverChildBuilderDelegate(
                                ...
                                return Container(
                                  ...
                                  padding:
                                      EdgeInsets.only(left: realW(20)),
                                  decoration: index == 0
                                      ? BoxDecoration(
                                          color: const Color(0xFF379BF2)
                                              .withOpacity(0.2),
                                          borderRadius: BorderRadius.only(
                                              topRight:
                    ...
                    Positioned(
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: const Color(0xFFFB5E74)
                                .withOpacity(0.2),
                            borderRadius: BorderRadius.only(
                                bottomLeft:
                                    Radius.circular(realW(36)),
                                topLeft:
                                    Radius.circular(realW(36))),
                          ),
                        ),
