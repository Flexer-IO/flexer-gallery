    ...
    return [
      ParallaxElement(
        ...
        child: ParallaxSvgBackground(
          ...
          svgAssetName: 'packages/showcase_library/assets/pawlik92_flutter_parallax_scroll/svg/background_icons.svg',
      ...
      ParallaxElement(
        ...
        child: ParallaxSvgBackground(
          ...
          settings: ParallaxBackgroundSettings.predefined(),
          svgAssetName: 'packages/showcase_library/assets/pawlik92_flutter_parallax_scroll/svg/layer3.svg',
      ...
      ParallaxElement(
        ...
        child: ParallaxSvgBackground(
          ...
          disableShadow: true,
          settings: ParallaxBackgroundSettings.predefined(),
          svgAssetName: 'packages/showcase_library/assets/pawlik92_flutter_parallax_scroll/svg/layer3_icons.svg',
      ...
      ParallaxElement(
        ...
        child: ParallaxSvgBackground(
          disableDeepEffect: _disabled3D,
          settings: ParallaxBackgroundSettings.predefined(),
          svgAssetName: 'packages/showcase_library/assets/pawlik92_flutter_parallax_scroll/svg/layer2.svg',
          translationOffset: Consts.svgLayersOffset,
        ),
      ),
      ParallaxElement(
        ...
        child: ParallaxSvgBackground(
          ...
          disableShadow: true,
          settings: ParallaxBackgroundSettings.predefined(),
          svgAssetName: 'packages/showcase_library/assets/pawlik92_flutter_parallax_scroll/svg/layer2_icons.svg',
      ...
      ParallaxElement(
        ...
        child: ParallaxSvgBackground(
          disableDeepEffect: _disabled3D,
          settings: ParallaxBackgroundSettings.predefined(),
          svgAssetName: 'packages/showcase_library/assets/pawlik92_flutter_parallax_scroll/svg/layer1.svg',
          translationOffset: Consts.svgLayersOffset,
        ),
      ),
    ];
