...
import 'state/state_container.dart' as state_container;
...
dynamic showPicker({
  ...
  required state_container.Time value,
  required void Function(state_container.Time) onChange,
  ...
  consts.TimePickerInterval? minuteInterval = consts.TimePickerInterval.ONE,
  consts.TimePickerInterval? secondInterval = consts.TimePickerInterval.ONE,
  ...
  TimeOfDay sunset = const TimeOfDay(hour: 18, minute: 0),
  int duskSpanInMinutes = 120,
  ...
  final timeValue = state_container.Time(
    hour: value.hour,
    minute: value.minute,
    second: value.second,
  );

  Widget timeModelBinding(Widget child) => state_container.TimeModelBinding(
        key: key,
        ...
        minuteInterval: minuteInterval != null
            ? state_container.TimePickerInterval.values[minuteInterval.index]
            : null,
        secondInterval: secondInterval != null
            ? state_container.TimePickerInterval.values[secondInterval.index]
            : null,
