...
class HourHandPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (showHeartShape) {
      ...
      path.quadraticBezierTo(radius * (-3.5) / 137.5,
          -radius + radius * 25.0 / 137.5, radius * (-15.0) / 137.5, -radius + radius / 4);
      ...
      path.quadraticBezierTo(radius * (3.5) / 137.5,
          -radius + radius * (25.0) / 137.5, 0.0, -radius + radius * 15.0 / 137.5);
    }
