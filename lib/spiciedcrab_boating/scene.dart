...
import 'deps/wave/config.dart';
import 'deps/wave/wave.dart';
...
class Scence extends StatefulWidget {
  @override
  ScenceState createState() => ScenceState();
}
...
class ScenceState extends State<Scence> {
          ...
          Container(
            decoration: BoxDecoration(
              gradient: RadialGradient(
                ...
                colors: _isNight
                    ? <Color>[
                        const Color(0xFF373938).withOpacity(_sunOpacity),
                        const Color(0xFF373938).withOpacity(_sunOpacity)
                      ]
                    : <Color>[const Color(0xFFc5d54e), const Color(0xFFa9b8cf)],
              ),
            ),
            child: Stack(
              ...
              children: [
                ...
                WaveWidget(
                  config: CustomConfig(
                    gradients: [
                      [
                        const Color(0xFF224c7e).withOpacity(0.7),
                        const Color(0xFF224c7e).withOpacity(0.3)
                      ],
                      [
                        const Color(0xFF224c7e).withOpacity(0.3),
                        const Color(0xFF224c7e).withOpacity(0.6)
                      ],
                    ],
                    durations: const [5200, 5000],
                    heightPercentages: const [0.432, 0.43],
  ...
  double get _trackDistance =>
      _trackMargin / 2 + _trackLength * (60 - currentMinutes) / 60 - _trackLength / 2;
  ...
  final ExactAssetImage _sunImage = ExactAssetImage("assets/images/sun.png");
  ...
  Future<ui.Image> _findSunImage() async {
    ...
    var key = await _sunImage.obtainKey(const ImageConfiguration());
  ...
  Offset _caculateSunPosition() {
    ...
    double minshipArea = MediaQuery.of(context).size.width -
        _trackDistance -
        handLength;
    double maxshipArea = MediaQuery.of(context).size.width -
        _trackDistance +
        handLength;
