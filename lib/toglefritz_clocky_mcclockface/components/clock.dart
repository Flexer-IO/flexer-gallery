...
/// Extension to provide zero‑padded string representation for integers.
extension IntZeroPadExtension on int {
  /// Returns a string representation of this integer padded with a leading zero
  /// if it is a single digit (e.g., `5` becomes `"05"`).
  String toZeroPaddedString() => toString().padLeft(2, '0');
}
