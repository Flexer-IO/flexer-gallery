...
void main() async {
  ...
  WindowOptions windowOptions = WindowOptions(
    ...
    alwaysOnTop: true,
    maximumSize: const Size(310, 310),
    minimumSize: const Size(271, 271),
  );
          ...
          child: Center(
            child: Container(
              ...
              child: Stack(
                children: [
                  // Main clock widget
                  Center(child: AnalogDigitalClock(currentTime: DateTime.now())),
                  // Theme toggle button
                  Positioned(
                    top: 10,
                    right: 10,
...
class AnalogDigitalClock extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final backgroundColor = isDarkMode
        ? (Colors.grey[900] ?? Colors.black).withOpacity(0.2)
        : (Colors.grey[100] ?? Colors.white).withOpacity(0.2);
