...
class _TicketsPageState extends State<TicketsPage>
  ...
  final List<FlightStopTicket> stops = [
  ...
  late final AnimationController cardEntranceAnimationController;
  late final List<Animation<double>> ticketAnimations;
  ...
  void initState() {
    ...
    ticketAnimations = stops.map((stop) {
      final int index = stops.indexOf(stop);
