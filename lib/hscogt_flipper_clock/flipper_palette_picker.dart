...
class FlipperPalettePicker extends StatefulWidget {
  const FlipperPalettePicker({
    super.key,
  ...
  final List<FlipperPalette> palettes;
  final int selectedIndex;
  final ValueChanged<int> onSelected;

  @override
  State<FlipperPalettePicker> createState() => _FlipperPalettePickerState();
}

class _FlipperPalettePickerState extends State<FlipperPalettePicker>
      ...
      child: AnimatedBuilder(
        ...
        child: Column(
          ...
          children: [
            _TriggerButton(
              open: _open,
              accent: widget.palettes[widget.selectedIndex].active.last,
              onTap: _handleTap,
            ),
            if (_open) ...[
...
class _DrawerPanelState extends State<_DrawerPanel> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      final itemCenter =
          8.0 + widget.selectedIndex * _itemExtent + _itemExtent / 2;
...
class _PaletteTile extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final accent = palette.active.last;
    return Material(
            ...
            children: [
              ClipRRect(
                ...
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    for (final c in palette.active)
                      Container(width: 16, height: 24, color: c),
                  ],
                ),
              ),
