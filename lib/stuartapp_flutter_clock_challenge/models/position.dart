...
/// A shared [Random] instance for generating random positions.
...
class Position {
  ...
  @override
  String toString() => 'Position{x: $x, y: $y, bearing: $bearing}';
}

Position lerpPosition(Position begin, Position end, double t) {
  return Position(
    lerpDouble(begin.x, end.x, t) ?? begin.x,
    lerpDouble(begin.y, end.y, t) ?? begin.y,
    begin.bearingTo(end),
  );
}