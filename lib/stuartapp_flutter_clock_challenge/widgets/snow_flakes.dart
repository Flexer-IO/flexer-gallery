// Copyright 2020 Stuart Delivery Limited. All rights reserved.
 ...
 // Minimal definition of WeatherCondition to satisfy the widget's requirements.
 // The original project provides a richer enum in its model.dart; we only need
 // the values referenced here.
 ...
 class _SnowFlakesState extends State<SnowFlakes> {
   ...
   void _initTimer(BoxConstraints constraints) {
     ...
     _timer = Timer.periodic(
         Duration(milliseconds: _snowFlakesInterval), (timer) {
       setState(() {
