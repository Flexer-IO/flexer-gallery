// Copyright 2020 Stuart Delivery Limited. All rights reserved.
 ...
 // NOTE: The original code imported WeatherCondition from the flutter_clock_helper
 // package. That import path was invalid in this repository, causing analysis errors.
 // To keep the widget behavior unchanged we provide a minimal definition of the
 // enum here. Only the `windy` value is required for the widget's logic.
 enum WeatherCondition { windy }
 ...
 class _WindyLeavesState extends State<WindyLeaves> {
   ...
   List<Widget> _buildLeaves(BoxConstraints constraints) {
     return _leavesPositions.map((leafPosition) {
       ...
       // This line should never be reached because all Side cases are handled.
       // ignore: dead_code
