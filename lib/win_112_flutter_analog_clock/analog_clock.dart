// Copyright 2019 The Chromium Authors. All rights reserved.
 ...
 // The original import was missing. Helper functions are now defined locally.
 // import 'deps/analog_clock/utility/widgetHelper.dart';
 ...
 class _AnalogClockState extends State<AnalogClock> {
   ...
   // -------------------------------------------------------------------------
   // Helper methods that were originally provided by widgetHelper.dart.
   // -------------------------------------------------------------------------
   ...
   /// Returns a generic decoration used for the clock containers.
   ...
   ThemeData customTheme(BuildContext context) => Theme.of(context);
             ...
             children: [
               ...
               Container(
                 ...
                 constraints: BoxConstraints(
                     minHeight: innerClockWidth / 2,
                     minWidth: innerClockWidth / 3,
                     maxHeight: clockWidth / 2,
               ...
               Container(
                 constraints:
                     BoxConstraints(minHeight: 5, minWidth: 5, maxHeight: 10, maxWidth: 10),
                 decoration: BoxDecoration(
