...
class Cannon extends Component
  ...
  Timer get initialTimer => Timer(1.0, onTick: onTick);

  late Timer timer;

  void onTick() {
    // parent is guaranteed to be a Ship via ParentIsA.
    final ship = parent;

    final shotPosition = ship.absolutePositionOfAnchor(Anchor.topCenter);
