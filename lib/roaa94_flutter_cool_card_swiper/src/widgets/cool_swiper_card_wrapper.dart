...
/// Simple constants used for the animation. These values are inferred
/// from the original library to keep the visual behaviour unchanged.
class Constants {
  static const double yOffset = 30.0;
