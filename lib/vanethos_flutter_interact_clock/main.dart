...
class _MyHomePageState extends State<MyHomePage> with TickerProviderStateMixin {
  ...
  late Animation<double> _minuteAnimationValue;

  late AnimationController _hourAnimationController;
  late Animation<double> _hourAnimationValue;

  late AnimationController _secondAnimationController;
  late Animation<double> _secondAnimationValue;
              ...
              builder: (context, widget) {
                ...
                return CustomPaint(
                  painter: PointerPainter(MediaQuery
                      ...
                      _getBackgroundColour(_date.add(Duration(hours: 12))), _secondAnimationValue.value),
                );}
            ),
            Column(
