...
class _GameState extends State<_Game> {
  ...
  void _onAcceptWithDetails(DragTargetDetails<_Team> details, Size size) {
                    ...
                    child: LayoutBuilder(
                      builder: (BuildContext context, BoxConstraints constraints) {
                        ...
                        return DragTarget<_Team>(
                          key: _dragTargetKey,
                          onAcceptWithDetails: (DragTargetDetails<_Team> details) {
                            _onAcceptWithDetails(details, _boardSize!);
                          },
                          onWillAccept: (_Team? team) => true,
                          builder: (BuildContext context, List<_Team?> candidateData, List<dynamic> rejectedData) {
