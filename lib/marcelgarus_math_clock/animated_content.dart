...
class _AnimatedContentState extends State<AnimatedContent>
  ...
  late final Animation<double> _newChildScale;
  late final Animation<double> _newChildOpacity;

  Widget? _oldChild;
  late final Animation<double> _oldChildScale;
  late final Animation<double> _oldChildOpacity;
