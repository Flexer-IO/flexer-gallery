...
import 'src/animated_border_container.dart';
import 'src/glitch.dart';
import 'src/glitch_text.dart';
import 'src/minimal_bar_chart.dart';
...
class _SciFiHomePageState extends State<SciFiHomePage> {
  ...
  Widget _itemBuilder3(BuildContext context, int index) {
    ...
    final Image image = Image.asset(_random.nextBool()
