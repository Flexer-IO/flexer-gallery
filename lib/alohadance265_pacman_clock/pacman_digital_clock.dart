...
class Map extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
      future: DefaultAssetBundle.of(context).loadString("packages/showcase_library/assets/alohadance265_pacman_clock/map.json"),
...
class _MovableObjectGroupState extends State<MovableObjectGroup> {
  ...
  void initState() {
    ...
    loadObjectDataFromJsonFile(
        jsonFile: "packages/showcase_library/assets/alohadance265_pacman_clock/pacman_position.json",
        movingObjType: MovableObjType.pacman);
    loadObjectDataFromJsonFile(
        jsonFile: "packages/showcase_library/assets/alohadance265_pacman_clock/white_ghost_position.json", color: Colors.white);
    loadObjectDataFromJsonFile(
        jsonFile: "packages/showcase_library/assets/alohadance265_pacman_clock/blue_ghost_position.json", color: Colors.blue);
    loadObjectDataFromJsonFile(
        jsonFile: "packages/showcase_library/assets/alohadance265_pacman_clock/green_ghost_position.json", color: Colors.green);
    loadObjectDataFromJsonFile(
        jsonFile: "packages/showcase_library/assets/alohadance265_pacman_clock/pink_ghost_position.json", color: Colors.pink);
  }
