...
import 'deps/camera/camera.dart';
import 'models/result.dart';
import 'deps/tflite/tflite.dart';
...
class TFLiteHelper {
  ...
  static Future<String> loadModel() async{
    ...
    return Tflite.loadModel(
      model: "packages/showcase_library/assets/umair13adil_tensorflow_lite_flutter/model_unquant.tflite",
      labels: "packages/showcase_library/assets/umair13adil_tensorflow_lite_flutter/labels.txt",
    );
  }
