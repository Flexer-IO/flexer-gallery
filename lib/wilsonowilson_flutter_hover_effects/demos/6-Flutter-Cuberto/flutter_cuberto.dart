...
class _FlutterCubertoState extends State<FlutterCuberto>
  ...
  late final AnimationController pointerScaleController1;
  late final AnimationController pointerScaleController2;
  late final Animation<double> pointerScaleAnimation1;
  late final Animation<double> pointerScaleAnimation2;
  ...
  void initState() {
    ...
    pointerScaleAnimation1 = Tween<double>(begin: 0.0, end: 1.0).animate(
      CurvedAnimation(curve: Curves.ease, parent: pointerScaleController1),
    );
    pointerScaleAnimation2 = Tween<double>(begin: 0.0, end: 1.0).animate(
  ...
  Widget build(BuildContext context) {
    return MouseRegion(
      ...
      child: Scaffold(
        backgroundColor: const Color.fromRGBO(10, 10, 20, 1),
